...
namespace Gmax.Migrations
{
    ...
    [Migration("20250508093513_ImpostateRelazioniOrdiniAcq")]
    partial class ImpostateRelazioniOrdiniAcq
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gmax.Models.Entities.AssegnazioneMagazzino", b =>
                {
                    ...
                    b.Property<int>("MagazzinoDestinazioneId")
                        .HasColumnType("integer");

                    b.Property<int>("MagazzinoOrigineId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MagazzinoDestinazioneId");

                    b.HasIndex("MagazzinoOrigineId");
            ...
            modelBuilder.Entity("Gmax.Models.Entities.ExpGiacenza", b =>
                {
                    b.Property<string>("TipoArticolo")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)");
                    ...
                    b.Property<string>("CodMagazzino")
                        .HasColumnType("text");

                    b.Property<DateTime>("DataInserimento")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int>("QtaGiacenza")
                        .HasColumnType("integer");

                    b.HasKey("TipoArticolo", "CodiceArticolo", "CodMagazzino");

                    b.HasIndex("CodMagazzino")
                        .IsUnique();

                    b.ToTable("ExpGiacenze");
                });

            modelBuilder.Entity("Gmax.Models.Entities.ExpOrdiniAcq", b =>
                {
                    b.Property<string>("TipoArticolo")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)");
                    ...
                    b.Property<int>("NroOrdineAcquisto")
                        .HasColumnType("integer");

                    b.Property<DateTime>("DataConsegnaAcquisto")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime>("DataInserimento")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime>("DataOrdineAcquisto")
                        .HasColumnType("timestamp without time zone");

                    b.Property<int>("QtaOrdineFornitore")
                        .HasColumnType("integer");

                    b.HasKey("TipoArticolo", "CodiceArticolo", "NroOrdineAcquisto", "DataConsegnaAcquisto");

                    b.ToTable("ExpOrdiniAcquisto");
                });

            modelBuilder.Entity("Gmax.Models.Entities.Magazzino", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Gmax.Models.Entities.AssegnazioneMagazzino", b =>
                {
                    b.HasOne("Gmax.Models.Entities.Magazzino", "MagazzinoDestinazione")
                        .WithMany("AssegnazioneDestinazioneList")
                        .HasForeignKey("MagazzinoDestinazioneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Gmax.Models.Entities.Magazzino", "MagazzinoOrigine")
                        .WithMany("AssegnazioneOrigineList")
                        .HasForeignKey("MagazzinoOrigineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("MagazzinoDestinazione");

                    b.Navigation("MagazzinoOrigine");
            ...
            modelBuilder.Entity("Gmax.Models.Entities.ExpGiacenza", b =>
                {
                    b.HasOne("Gmax.Models.Entities.Magazzino", "Magazzino")
                        .WithOne("Giacenza")
                        .HasForeignKey("Gmax.Models.Entities.ExpGiacenza", "CodMagazzino")
                        .HasPrincipalKey("Gmax.Models.Entities.Magazzino", "CodMagazzino")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Gmax.Models.Entities.ArticoloCK", "Articolo")
                        .WithMany("GiacenzaList")
            ...
            modelBuilder.Entity("Gmax.Models.Entities.Magazzino", b =>
                {
                    b.HasOne("Gmax.Models.Entities.OrdineProduzioneCK", "OrdineProduzioneCK")
                        .WithOne("Magazzino")
                        .HasForeignKey("Gmax.Models.Entities.Magazzino", "NroLancio", "NroSottolancio");
            ...
            modelBuilder.Entity("Gmax.Models.Entities.ArticoloCK", b =>
                {
                    b.Navigation("GiacenzaList");

                    b.Navigation("OrdineProdCompCKList");

                    b.Navigation("OrdineProduzioneLancioList");

                    b.Navigation("OrdiniAcqList");
                });

            modelBuilder.Entity("Gmax.Models.Entities.Magazzino", b =>
                {
                    b.Navigation("AssegnazioneDestinazioneList");

                    b.Navigation("AssegnazioneOrigineList");

                    b.Navigation("Giacenza")
                        .IsRequired();
                });
