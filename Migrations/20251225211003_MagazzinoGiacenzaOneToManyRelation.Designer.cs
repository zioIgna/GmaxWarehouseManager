...
namespace Gmax.Migrations
{
    ...
    [Migration("20251225211003_MagazzinoGiacenzaOneToManyRelation")]
    partial class MagazzinoGiacenzaOneToManyRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gmax.Models.Entities.ExpGiacenza", b =>
                {
                    b.HasOne("Gmax.Models.Entities.Magazzino", "Magazzino")
                        ...
                        .HasForeignKey("CodMagazzino")
                        .HasPrincipalKey("CodMagazzino")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
